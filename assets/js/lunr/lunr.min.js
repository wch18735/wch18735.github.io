 ...
 */
 ! function() {
    ...
    e.version = "2.3.9", e.utils = {}, e.utils.warn = function(e) {
            return function(t) {
            ...
            for (var i = new e.TokenSet, n = [{
                ...
                if (0 != s.editsRemaining) {
                    ...
                    if (0 == s.str.length && (u["final"] = !0), n.push({
                            ...
                            editsRemaining: s.editsRemaining - 1,
                            str: s.str.slice(1)
                        }), 1 == s.str.length && (s.node["final"] = !0), s.str.length >= 1) {
                    ...
                    for (var c = s[l], h = 0; h < u; h++) {
                        ...
                        if (d == c || "*" == c) {
                            var f = i.node.edges[d],
                                ...
                                y = f["final"] && p["final"],
                                m = void 0;
                            d in i.output.edges ? (m = i.output.edges[d], m["final"] = m["final"] || y) : (m = new e.TokenSet, m["final"] = y, i.output.edges[d] = m), n.push({
                                qNode: p,
                                output: m,
                                node: f
                            })
